...
<body>
       <div class="container">
        <div class="title"> Ajouter un utilisateur <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
...
if(isset($_POST['btsubmit']))
{
    ...
    $reqAdd="INSERT INTO utilisateur (Cin,username,email,password,fonction) VALUES('$Cin','$username','$Email','$password','$Fonction')";
