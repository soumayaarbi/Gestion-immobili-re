...
<body>
    ...
    <a href="ajoutb.php"><button type="button" class="btn btn-outline-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-plus" viewBox="0 0 16 16">
...
<table width="100%" border="1px">
        <tr border="1">
            ...
            <th style="text-align:center;"> Prix d'achat(Dt) </th>
...
<tr>
    ...
    <td style="text-align:center;"> <a href="supprimerb.php?suput=<?php echo $ligne['Matricule'];?>"onclick="return(confirm('Etes-vous sûr de vouloir supprimer ce Bien?'));">
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-x" viewBox="0 0 16 16">
  ...
  <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
    ...
    <td style="text-align:center;"> <a href="modifierb.php?modi=<?php echo $ligne['Matricule']; ?>"><button  type="button" class="btn btn-outline-secondary"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
...
<div class="d-grid gap-2 d-md-flex justify-content-md-end">
				...
				<a href="admin2.php" class="btn btn-outline-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
